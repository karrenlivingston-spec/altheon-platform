...
export const DS_PAGE_ROOT =
  "w-full bg-[#F8FAFC] -mx-6 px-8 py-8 pb-10";
...
export const DS_FILTER_BAR =
  "mb-6 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm";

export const DS_INPUT =
  "w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-900 focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-500/20";
...
export const DS_SECTION_HEADER =
  "mb-4 text-sm font-semibold uppercase tracking-wider text-gray-900";

export const DS_PRIMARY_BTN =
  "rounded-lg bg-[#16A34A] px-4 py-2 text-sm font-medium text-white transition-colors duration-150 hover:bg-[#15803D]";
export const DS_SECONDARY_BTN =
  "rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition-colors duration-150 hover:bg-gray-50";
export const DS_DESTRUCTIVE_BTN =
  "rounded-lg border border-red-200 bg-white px-4 py-2 text-sm font-medium text-red-600 transition-colors duration-150 hover:bg-red-50";
